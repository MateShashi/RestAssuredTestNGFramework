...
public class PlaylistTests extends BaseTest {
    ...
    @Test(description = "Should be able to get a playlist details")
    public void ShouldBeAbleToGetAPlaylist(){
        Playlist requestPlaylist = playlistBuilder("Shashi's Playlist", "My New playlist updated", false);
    ...
    @Story("Create a playlist story")
    @Test(description = "Should be able to create a playlist without name")
    ...
    @Story("Create a playlist story")
    @Test(description = "Should be able to create a playlist with expired token")
